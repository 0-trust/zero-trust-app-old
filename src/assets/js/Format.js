...
BaseFormatPanel.prototype.createOption = function (label, isCheckedFn, setCheckedFn, listener, fn) {
    ...
    div.style.padding = '4px 4px 4px 4px';//Dayo
    div.style.whiteSpace = 'nowrap';
    div.style.textOverflow = 'ellipsis';
    div.style.overflow = 'hidden';
    div.style.width = '200px';
    // div.style.height = '18px';
    div.style.height = '25px';//Dayo
...
TextFormatPanel.prototype.addFont = function (container) {
    ...
    this.addArrow(fontMenu, 22);
    fontMenu.style.width = '200px';
    fontMenu.style.height = '25px';
    ...
    positionSelect.style.padding = '0px';
    positionSelect.style.height = '24px';
    ...
    dirSelect.style.padding = '0px';
    dirSelect.style.height = '24px';
...
StyleFormatPanel.prototype.addStroke = function (container) {
    ...
    var elt = this.addArrow(edgeShape, 20);
    elt.nextSibling.style.position = 'relative';
    elt.nextSibling.style.top = '0px';
    elt = this.addArrow(edgeStyle, 20);
    elt.nextSibling.style.position = 'relative';
    elt.nextSibling.style.top = '0px';
    edgeStyle.getElementsByTagName('img')[0].style.top = '-1px';
    var xx = this.addArrow(lineStart, 20, true);
    xx.style.marginRight = '6px'
    this.addArrow(lineEnd, 20, true);

    var symbol = this.addArrow(pattern, 25);
    symbol.className = 'geIcon';
    symbol.style.width = 'auto';

    var altSymbol = this.addArrow(altPattern, 21);
    altSymbol.className = 'geIcon';
    altSymbol.style.width = '28px';
    altSymbol.style.marginBottom = '1px'
    ...
    lineStart.style.width = '65px';
    lineEnd.style.marginLeft = '6px';
            ...
            for (var i = 0; i < cells.length; i++) {
                ...
                if (style['labelBackgroundColor'] != null) {
                    graph.updateCellStyles({
                        'labelBackgroundColor': (graphStyle != null) ?
